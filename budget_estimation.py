...
def budget_calc(org, dest, days, date:list , people_number=None, local_constraint = None):
    ...
    flight_prices = flight_data['Price'].values
    hotel_prices = hotel_data['Price'].values
    restaurant_prices = restaurant_data['average cost'].values

    lowest_budget = (estimate_budget(flight_prices, "lowest") * multipliers[days]["flight"] + 
    ...
    highest_budget = (estimate_budget(flight_prices, "highest") * multipliers[days]["flight"] + 
    ...
    average_budget = (estimate_budget(flight_prices, "average") * multipliers[days]["flight"] + 
    ...
    return {'lowest': lowest_budget, 'highest': highest_budget, 'average': average_budget}